1- patient_age_at_enrollment:
    ...
    Type:
      ...
      value_type: number
		...
		Test - Changed row 4 from a number to the word "Joker"
...
2- sex:
    ...
    - F
		...
		Test - Changed row 10 to "Hello." Going by the model, nothing should load from this file for sex. The model expects "M" or "F" and the values are coming in as "Male" and "Female"
...
3- neutered_indicator:
    ...
    Type: TBD
		...
		Test - I don't think this is testable since the Type is TBD, but I changed row 2 from "Yes" to "Fred" in case it's expecting Yes or No.
...
4- weight:
    ...
    Type: TBD
		...
		Test - Not sure this is testable but I changed row 7 from a number to the word, "noneya"
...
5-  breed:
    ...
    - http://localhost/terms/domain/breed
		...
		Test - Changed row six from "Mixed Breed" to "6." 
