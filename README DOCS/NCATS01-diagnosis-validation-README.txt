1- disease_term:
    ...
    Req: true
		...
		Test 1 - Removed the value in row 1
		Test 2 - Put in ????? as the value in row 8
...
2- pathology_report:
    ...
    Type: boolean
		...
		Test 1 - removed "yes" in row 20 and added "Frank." Not sure this will break it
...
3- follow_up_data:
    ...
    Type: boolean
		...
		Test 1- removed "yes" in row 21 and added "Hello." Not sure this will break it
...
4-  treatment_data:
    ...
    Type: boolean
		...
		Test 1- removed "yes" in row 22 and added "awesome." Not sure this will break it
...
5-  concurrent_disease:
    ...
    Type: boolean
		...
		Test 1- removed "no" in row 23 and added "Claire." Not sure this will break it
...
6- histological_grade:
    ...
    - http://localhost/terms/domain/histological_grade
		...
		Test 1- removed "III" in row 18 and put in "Kevin" as the value. I don't think this will break it.
...
7- primary_disease_site:
    ...
    - http://localhost/terms/domain/primary_disease_site
		...
		Test 1- removed "Tibia" in row 15 and replaced it with the value "7." Not sure this will break it.
